...
Tablero::Tablero() {
    /// Casillas Normales
    casillas.emplace_back(new Casilla(490.5332, 1094.2657, 0));
    ...
    casillas.emplace_back(new Casilla(37.73333, 565.9998, 0));
    ...
    casillas.emplace_back(new Casilla(565.9998, 1094.2657, 0));

    /// Casillas Recta Final Amarillo
    recta_final_amarillo.emplace_back(new Casilla(565.9998, 1018.7991, 4));
    ...
    recta_final_verde.emplace_back(new Casilla(113.1999, 565.9998, 3));
    ...
    recta_final_rojo.emplace_back(new Casilla(565.9998, 113.1999, 1));
    ...
    recta_final_azul.emplace_back(new Casilla(1018.7991, 565.9998, 2));
