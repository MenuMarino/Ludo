    ...
    while (window.isOpen()) {
        ...
        if (turno == 0) { /// TURNO AMARILLO
            ...
            if (clicked_on_j1_f1) { /// click en la primera ficha
                ...
                reset2jugadores(4, amarillo_saco_6);
            ...
            if (clicked_on_j2_f1) { /// click en la primera ficha
                ...
                reset2jugadores(3, verde_saco_6);
    ...
    while (window.isOpen()) {
        ...
        if (turno == 0) { /// TURNO AMARILLO
            ...
            if (clicked_on_j1_f1) { /// click en la primera ficha
                ...
                reset3jugadores(4, amarillo_saco_6);
                clicked_on_j1_f1 = false;
            ...
            if (clicked_on_j2_f1) { /// click en la primera ficha
                ...
                reset3jugadores(3, verde_saco_6);
                clicked_on_j2_f1 = false;
